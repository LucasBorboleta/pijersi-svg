...
"""pijersi_start.py installs and draws SVG pictures for the PIJERSI boardgame."""
...
_pijersi_svg_script = os.path.join(_product_home, "pijersi_svg", "pijersi_svg.py")
...
print()
print("pijersi_svg ...")
subprocess.run(args=[_venv_python_executable, _pijersi_svg_script], shell=False, check=True)
print()
print("pijersi_svg done")
