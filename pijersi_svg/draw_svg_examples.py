...
"""example_svg.py draws SVG examples."""
...
def draw_example_1():
    ...
    print()
    print("draw_example_1: save as SVG ...")
    d.save_svg(os.path.join(_pictures_dir, 'example_1.svg'))
    print("draw_example_1: save as SVG done")

    print()
    print("draw_example_1: save as PNG ...")
    d.save_png(os.path.join(_pictures_dir, 'example_1.png'))
    print("draw_example_1: save as PNG done")

    print()
    print("draw_example_1: done")
